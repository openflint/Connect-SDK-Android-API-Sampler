...
public class MediaPlayerFragment extends BaseFragment {
    ...
    public static final int REFRESH_INTERVAL_MS = (int) TimeUnit.SECONDS
            .toMillis(1);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_media_player,
                container, false);
        ...
        fastForwardButton = (Button) rootView
        ...
        positionTextView = (TextView) rootView
                .findViewById(R.id.stream_position);
        durationTextView = (TextView) rootView
                .findViewById(R.id.stream_duration);
        mediaInfoTextView = (TextView) rootView
        ...
        mediaInfoImageView = (ImageView) rootView
                .findViewById(R.id.mediaInfo_imageView);

        buttons = new Button[] { photoButton, videoButton, audioButton,
                playButton, pauseButton, stopButton, rewindButton,
                fastForwardButton, closeButton, mediaInfoButton };
        ...
        if (getTv().hasCapability(MediaPlayer.Display_Image)) {
            ...
            photoButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    getMediaPlayer().displayImage(imagePath, mimeType, title,
                            description, icon,
        ...
        if (getTv().hasCapability(MediaPlayer.Display_Video)) {
            ...
            videoButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    getMediaPlayer().playMedia(videoPath, mimeType, title,
                            description, icon, false,
                            new MediaPlayer.LaunchListener() {
        ...
        if (getTv().hasCapability(MediaPlayer.Display_Audio)) {
            ...
            audioButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    getMediaPlayer().playMedia(mediaURL, mimeType, title,
                            description, iconURL, shouldLoop,
                            new MediaPlayer.LaunchListener() {
    ...
    public void enableMedia() {
        ...
        fastForwardButton.setEnabled(getTv().hasCapability(
    ...
    public OnSeekBarChangeListener volumeListener = new OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int position,
                boolean fromUser) {
            if (fromUser)
                getVolumeControl().setVolume(
                        (float) mVolumeBar.getProgress() / 100.0f, null);
        }
    };
    ...
    private void startUpdating() {
        ...
        refreshTimer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                if (mMediaControl != null && getTv() != null
                        && getTv().hasCapability(MediaControl.Position)) {
    ...
    private MediaInfoListener mediaInfoListener = new MediaInfoListener() {
        ...
        public void onSuccess(MediaInfo mediaInfo) {
            ...
            if (stringUrl != null)
                new DownloadImageTask(mediaInfoImageView).execute(stringUrl);
        }
    ...
    private String formatTime(long millisec) {
        ...
        String time;
        if (hours > 0) {
            time = String.format(Locale.US, "%d:%02d:%02d", hours, minutes,
                    seconds);
        } else {
